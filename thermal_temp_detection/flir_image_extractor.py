...
class FlirImageExtractor:
    ...
    def get_image_type(self):
        ...
        :return:
        """
        meta_json = subprocess.check_output([self.exiftool_path, "-RawThermalImageType", "-j", self.flir_img_filename], shell = True)
    ...
    def extract_thermal_image(self):
        ...
        meta_json = subprocess.check_output([self.exiftool_path, self.flir_img_filename, '-Emissivity', '-SubjectDistance', '-AtmosphericTemperature',
